...
class WallpaperSetterApp(QMainWindow):
    BG_COLOR = "#2d2d2d"
    FG_COLOR = "#ffffff"
    FONT_FAMILY = "Noto Sans JP"  # Noto Sans JPに設定

    def __init__(self):
        super().__init__()
        self.setWindowTitle("NO License!!!!!!!!!!!!!!!!!!!!")
    ...
    def handle_mode_switch(self, dark):
        ...
        if success:
            QMessageBox.information(self, "ℹ️Success", message)
        else:
    ...
    def apply_wallpaper(self):
        if self.wallpaper_path:
            ...
            QMessageBox.warning(self, "⚠️Warning", "壁紙を選択してください")
